...
def train(train_loader, model, optimizer, epoch, save_path, writer):
    ...
    try:
        for i, (images, gts, edges) in enumerate(train_loader, start=1):
            ...
            map_4, map_3, map_2, map_1 = model(images)
            # loss1 = structure_loss(map_4, gts)
            # loss2 = structure_loss(map_3, gts)
            # loss3 = structure_loss(map_2, gts)
            # loss4 = structure_loss(map_1, gts)

            loss1 = CE(map_4, gts) + iou_loss(map_4, gts)
            loss2 = CE(map_3, gts) + iou_loss(map_3, gts)
            loss3 = CE(map_2, gts) + iou_loss(map_2, gts)
            loss4 = CE(map_1, gts) + iou_loss(map_1, gts)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_root', type=str, default='C:/Users/Lenovo/Desktop/Datasets/TrainDataset/',
                        help='the training rgb images root')
    parser.add_argument('--val_root', type=str, default='C:/Users/Lenovo/Desktop/Datasets//TestDataset/CAMO/',
                        help='the test rgb images root')
    parser.add_argument('--gpu_id', type=str, default=' ',
                        help='train use gpu')
    parser.add_argument('--save_epoch', type=int, default=5,
                        help='every N epochs save your trained snapshot')
    parser.add_argument('--save_path', type=str, default='./pytorch_lib/snapshot/',
